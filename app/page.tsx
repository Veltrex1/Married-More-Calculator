      ...
      {error && (
        <div className="flex items-start gap-2 rounded-lg bg-rose-50/80 p-3 text-rose-700 ring-1 ring-rose-200/60">
          ...
          <div className="space-y-0.5">
            <p className="text-sm">Let&rsquo;s fix a couple of dates before we continue.</p>
        ...
        <>
          ...
          >
            <div className="space-y-2">
              ...
              {result.isFuture ? (
                <p className="text-slate-700">
                  You&rsquo;ll reach this milestone in{' '}
                  <span className="font-medium text-rose-600">
      ...
      {!result && (
        <>
          ...
          <p className="text-sm text-slate-500">
            Enter your dates to see when you&rsquo;ll have been married more than not.
          </p>
        </>
      )}
    </div>
  ...
  return (
    <div className="space-y-6 text-left">
      ...
      <p className="text-sm text-slate-600 md:text-base">
        See the exact moment you&rsquo;ll have been married more than not.
      </p>
          ...
          {calculateForBoth && (
            <div className="space-y-1">
              <Label htmlFor="spouse-birth" className="text-slate-800">
                Spouse&rsquo;s date & time of birth
              </Label>
              <Input
                id="spouse-birth"
                type="datetime-local"
      ...
      {result ? (
        ...
        <>
          <Separator className="my-2 opacity-50" />
          <p className="text-sm text-slate-500">
            Enter your dates to see the exact moment you&rsquo;ll have been married more than not.
          </p>
        </>
      )}
    </div>
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-5xl flex-col items-center justify-center px-6 py-20 sm:px-8 sm:py-24 md:px-10 lg:px-12 lg:py-28">
        ...
        >
          ...
          <p className="mx-auto max-w-xl text-base text-slate-600 md:text-lg">
            The day you&rsquo;ve officially spent more of your life married than not.
          </p>
